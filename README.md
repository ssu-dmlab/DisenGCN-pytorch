...
The original code uses neighborhood sampling to make the tensor parallelization easier, but our implmentation does not use the sampling technique. However, our implementation is likely to know the influence of all neighbors.
